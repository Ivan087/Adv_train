...
############
# python test.py --model-path ./cifar_free/model.pth --batch-size 512 --dataset cifar10 --attack-iters 10 --attack fgsm --out-logfile tmp.log
# python test.py --model-path ./fashion_free/model.pth --batch-size 512 --dataset fashionmnist --attack-iters 10 --attack fgsm --out-logfile tmp.log
# python test.py --model-path ./tiny_free/model.pth --batch-size 512 --dataset tinyimagenet --attack-iters 10 --attack fgsm --out-logfile tmp.log

# python test.py --model-path ./cifar_free_ssa/model.pth --batch-size 512 --dataset cifar10 --attack-iters 10 --attack fgsm --out-logfile tmp.log
# python test.py --model-path ./fashion_free_ssa/model.pth --batch-size 512 --dataset fashionmnist --attack-iters 10 --attack fgsm --out-logfile tmp.log
# python test.py --model-path ./tiny_free_ssa/model.pth --batch-size 512 --dataset tinyimagenet --attack-iters 10 --attack fgsm --out-logfile tmp.log

# python test.py --model-path ./cifar_free/model.pth --batch-size 512 --dataset cifar10 --attack-iters 20 --attack pgd --out-logfile tmp.log
# python test.py --model-path ./fashion_free/model.pth --batch-size 512 --dataset fashionmnist --attack-iters 20 --attack pgd --out-logfile tmp.log
# python test.py --model-path ./tiny_free/model.pth --batch-size 512 --dataset tinyimagenet --attack-iters 20 --attack pgd --out-logfile tmp.log
# python test.py --model-path ./cifar_free_ssa/model.pth --batch-size 512 --dataset cifar10 --attack-iters 20 --attack pgd --out-logfile tmp.log
# python test.py --model-path ./fashion_free_ssa/model.pth --batch-size 512 --dataset fashionmnist --attack-iters 20 --attack pgd --out-logfile tmp.log
# python test.py --model-path ./tiny_free_ssa/model.pth --batch-size 512 --dataset tinyimagenet --attack-iters 20 --attack pgd --out-logfile tmp.log

# python test.py --model-path ./cifar_free/model.pth --batch-size 512 --dataset cifar10 --attack-iters 20 --attack bim --out-logfile tmp.log
# python test.py --model-path ./fashion_free/model.pth --batch-size 512 --dataset fashionmnist --attack-iters 20 --attack bim --out-logfile tmp.log
# python test.py --model-path ./tiny_free/model.pth --batch-size 512 --dataset tinyimagenet --attack-iters 20 --attack bim --out-logfile tmp.log
# python test.py --model-path ./cifar_free_ssa/model.pth --batch-size 512 --dataset cifar10 --attack-iters 20 --attack bim --out-logfile tmp.log
# python test.py --model-path ./fashion_free_ssa/model.pth --batch-size 512 --dataset fashionmnist --attack-iters 20 --attack bim --out-logfile tmp.log
# python test.py --model-path ./tiny_free_ssa/model.pth --batch-size 512 --dataset tinyimagenet --attack-iters 20 --attack bim --out-logfile tmp.log
